...
/**
 * Main Elementor Bubbletech Class
 *
 * The init class that runs the Elementor Bubbletech plugin.
 ...
 */
final class Elementor_Bubbletech {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-bubbletech' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_BUBBLETECH ) );
...
// Instantiate Elementor_Bubbletech.
new Elementor_Bubbletech();